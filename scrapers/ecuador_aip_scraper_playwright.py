...
class EcuadorAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://www.ais.aviacioncivil.gob.ec/ifis3/"
		self.base_url = "https://www.ais.aviacioncivil.gob.ec/ifis3"
