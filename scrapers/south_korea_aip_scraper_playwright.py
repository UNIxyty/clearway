...
class SouthKoreaAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://aim.koca.go.kr/eaipPub/Package/2025-10-29-AIRAC/html/index-en-GB.html"
		self.base_url = "https://aim.koca.go.kr/eaipPub/Package/2025-10-29-AIRAC/html"
...
def main():
	s = SouthKoreaAIPScraperPlaywright()
