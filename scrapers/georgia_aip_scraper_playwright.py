...
class GeorgiaAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://airnav.ge/eaip/2025-10-30-000000/html/index-en-GB.html"
		self.base_url = "https://airnav.ge/eaip/2025-10-30-000000/html"
...
def main():
	s = GeorgiaAIPScraperPlaywright()
	print(s.get_airport_info("UGTB"))
