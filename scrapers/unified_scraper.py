...
class UnifiedScraper:
    ...
    def get_country_from_code(self, airport_code: str) -> str:
        ...
        # Finland airports start with 'EF' (e.g., EFHK, EFTU)
    ...
    def get_airport_info(self, airport_code: str) -> Dict:
        ...
        if country == 'USA':
            ...
            if not self.finland_scraper:
                self.finland_scraper = FinlandAIPScraperPlaywright()
            return self.finland_scraper.get_airport_info(airport_code)
    ...
    def close(self):
        ...
        if self.finland_scraper:
            self.finland_scraper.close()
