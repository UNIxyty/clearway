...
class MalaysiaAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://aip.caam.gov.my/aip/eAIP/2025-09-09/html/index-en-MS.html"
		self.base_url = "https://aip.caam.gov.my/aip/eAIP/2025-09-09/html"
...
def main():
	s = MalaysiaAIPScraperPlaywright()
