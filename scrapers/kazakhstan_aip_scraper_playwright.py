...
class KazakhstanAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://www.ans.kz/AIP/eAIP/2025-10-30-AIRAC/html/index-en-GB.html"
		self.base_url = "https://www.ans.kz/AIP/eAIP/2025-10-30-AIRAC/html"
...
def main():
	s = KazakhstanAIPScraperPlaywright()
	print(s.get_airport_info("UACC"))
