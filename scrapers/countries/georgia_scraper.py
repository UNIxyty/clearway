...
class GeorgiaAIPScraper(BaseEAIPScraperPlaywright):
	def __init__(self, headless: bool = True):
		super().__init__(index_url="https://airnav.ge/eaip/2025-10-30-000000/html/index-en-GB.html")


def get_airport_info(airport_code: str, headless: bool = True) -> Dict:
	scraper = GeorgiaAIPScraper(headless=headless)
