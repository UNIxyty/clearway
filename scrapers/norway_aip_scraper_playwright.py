...
class NorwayAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://aim-prod.avinor.no/no/AIP/"
		self.base_url = "https://aim-prod.avinor.no/no/AIP"
...
def main():
	s = NorwayAIPScraperPlaywright()
	print(s.get_airport_info("ENGM"))
