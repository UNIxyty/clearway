...
class TaiwanAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://ais.caa.gov.tw/eaip/AIRAC AIP AMDT 05-25_2025_09_04\index.html"
		self.base_url = "https://ais.caa.gov.tw/eaip"
