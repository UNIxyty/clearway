...
class UnitedArabEmiratesAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://www.gcaa.gov.ae/en/ais"
		self.base_url = "https://www.gcaa.gov.ae/en/ais"
...
def main():
	s = UnitedArabEmiratesAIPScraperPlaywright()
