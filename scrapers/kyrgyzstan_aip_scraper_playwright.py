...
class KyrgyzstanAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "http://kan.kg/ais/eaip/2025-10-30-AIRAC/html/index_commands.html"
		self.base_url = "http://kan.kg/ais/eaip/2025-10-30-AIRAC/html"
...
def main():
	s = KyrgyzstanAIPScraperPlaywright()
