...
class SwedenAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://aro.lfv.se/content/eaip/AIRAC AIP AMDT 6-2025_2025_10_30\index-v2.html"
		self.base_url = "https://aro.lfv.se/content/eaip"
...
def main():
	s = SwedenAIPScraperPlaywright()
	print(s.get_airport_info("ESSA"))
