...
class PortugalAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://ais.nav.pt/wp-content/uploads/AIS_Files/eAIP_Current/eAIP_Online/eAIP/html/index.html"
		self.base_url = "https://ais.nav.pt/wp-content/uploads/AIS_Files/eAIP_Current/eAIP_Online/eAIP/html"
...
def main():
	s = PortugalAIPScraperPlaywright()
	print(s.get_airport_info("LPPT"))
