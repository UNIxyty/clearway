...
class CaboVerdeAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://eaip.asa.cv/2024-04-18-AIRAC/html/index-en-GB.html"
		self.base_url = "https://eaip.asa.cv/2024-04-18-AIRAC/html"
...
def main():
	s = CaboVerdeAIPScraperPlaywright()
