...
class OmanAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://aim.caa.gov.om/AIRAC_eAIPOman-3-25/#"
		self.base_url = "https://aim.caa.gov.om/AIRAC_eAIPOman-3-25/#"
