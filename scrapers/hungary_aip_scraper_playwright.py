...
class HungaryAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://ais-en.hungarocontrol.hu/aip"
		self.base_url = "https://ais-en.hungarocontrol.hu/aip"
...
def main():
	s = HungaryAIPScraperPlaywright()
	print(s.get_airport_info("LHBP"))
