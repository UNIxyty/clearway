...
class UnitedKingdomAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://www.aurora.nats.co.uk/htmlAIP/Publications/2025-10-30-AIRAC/html/index-en-GB.html"
		self.base_url = "https://www.aurora.nats.co.uk/htmlAIP/Publications/2025-10-30-AIRAC/html"
...
def main():
	s = UnitedKingdomAIPScraperPlaywright()
	print(s.get_airport_info("EGLL"))
