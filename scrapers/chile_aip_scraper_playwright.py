...
class ChileAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://aipchile.dgac.gob.cl/aip/vol1/seccion/airac"
		self.base_url = "https://aipchile.dgac.gob.cl/aip/vol1/seccion/airac"
