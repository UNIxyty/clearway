...
class PolandAIPScraperPlaywright:
	def __init__(self):
		self.index_url = "https://www.ais.pansa.pl/en/publications/aip-poland/"
		self.base_url = "https://www.ais.pansa.pl/en/publications/aip-poland"
...
def main():
	s = PolandAIPScraperPlaywright()
	print(s.get_airport_info("EPWA"))
